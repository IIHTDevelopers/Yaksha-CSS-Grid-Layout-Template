...
const requiredStyles = [
    {
        ...
        properties: [
            ...
            { key: 'grid-template-columns', value: 'repeat' },
            { key: 'gap', value: '10px' }
        ]
    }
];
...
const cssTestCase = {
    testCaseName: 'CSS grid-container Styles Test',
    testCaseType: 'boundary',
...
const requiredStyles2 = [
    {
        selector: 'grid-item',
        properties: [
            { key: 'background-color', value: 'lightgreen' },
...
const cssTestCase2 = {
    testCaseName: 'CSS grid-item Styles Test',
    testCaseType: 'boundary',
    testLogic: checkCssStyles,
...
const htmlAttributesTestCase = {
    ...
    extraParams: [[
        { tag: 'div', attribute: 'class', value: 'grid-container' }
    ]]
};
